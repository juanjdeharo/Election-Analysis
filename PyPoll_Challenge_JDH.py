...
with open(file_to_save, "w") as txt_file:
    ...
    larget_county_turnout_summary = (
        f"-------------------------\n"
        f"County with the largest voter turnout: {largest_turnout_county}\n"
        f"Voter turnout: {largest_turnout_county_votes:,}\n"
        f"-------------------------\n")
    print(larget_county_turnout_summary)

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(larget_county_turnout_summary)
